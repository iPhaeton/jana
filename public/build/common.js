...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"index","3":"shop","4":"async"}[chunkId]||chunkId) + ".js";
	...
	function headMenuListener() {
	        ...
	        $(document.documentElement).on("click keydown", function (event) {
	            ...
	            if (!(0, _axillaries.findTarget)($(event.target), "details-button edit-button rm-button signin signup") || event.keyCode === 27) {
	                __webpack_require__.e/* nsure */(2, function (require) {
	                    var ModalWindow = __webpack_require__(6).ModalWindow;
	    ...
	    function showAuthWindow(id) {
	        __webpack_require__.e/* nsure */(2/* duplicate */, function (require) {
	            var AuthWindow = __webpack_require__(6).AuthWindow;
