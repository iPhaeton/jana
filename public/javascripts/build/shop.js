...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Thumbnails = exports.thumbnails = exports.parseConfig = exports.socket = exports.storedData = exports.storedConfig = undefined;
	...
	var _searchPanel = __webpack_require__(5);
	...
	var thumbnails, storedData, //data and configare not necesarily needed to be reloaded on every getData
	...
	function getData(url, callback) {
	    ...
	    function (callback) {
	        ...
	        exports.storedConfig = storedConfig = config = parseConfig(results[0][0]);
	        exports.storedData = storedData = data = results[1];
	        data.url = url;
	...
	function createContent(data, config) {
	    ...
	    if (!thumbnails) exports.thumbnails = thumbnails = new Thumbnails("#commodity-list", data, config);
	    thumbnails.clear();
	...
	Thumbnails.prototype.add = function (dataToAdd, done) {
	    ...
	    exports.storedData = storedData = this.data;
	...
	function Thumbnail(parent, data, config, dataUrl) {
	    ...
	    this.details = new _modals.Details(this);
	    var self = this;
	...
	Thumbnail.prototype.showDirList = function (event) {
	    ...
	    (0, _ajaxClient.makeListRequest)("/list?dir=images", function (err, list) {
	        ...
	        for (var i = 0; i < list.length; i++) {
	            files[list[i]] = [_this.chooseImageOnServer.bind(_this), _this.showDirPopupMenu.bind(_this)];
	        };
	
	        var menu = new PopupMenu(_this.elem, event, files, true);
	...
	EditPanel.prototype.addCommodity = function () {
	    var questionnaire = new _modals.Dialog({
	        "Категория": "Лыжи",
	        "Название": ""
	    }, "Commodity");
	...
	EditPanel.prototype.addCategory = function () {
	    var dialog = new _modals.Dialog({ "Категория": "" }, "Category", function (form) {
	...
	exports.storedConfig = storedConfig;
